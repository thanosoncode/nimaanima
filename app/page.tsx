          ...
          <section>
            ...
            <div className="rounded-xl border border-gray overflow-hidden flex flex-col items-center">
              ...
              <div className="p-4">
                ...
                <p>
                  If you’ve seen my work, you may have noticed that I love
                  weaving loops. I really like the soft texture that they give
                  weaves. They also give a more organic feel to my weaves.
                </p>
                <b>read more</b>
              </div>
            </div>
